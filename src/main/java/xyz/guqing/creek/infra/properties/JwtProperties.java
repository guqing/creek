 ...
 * @date 2022-04-12
 */
@ConfigurationProperties(prefix = "creek.security.oauth2.jwt")
public class JwtProperties {
    ...
    public RSAPublicKey readPublicKey() throws IOException {
        String key = "creek.security.oauth2.jwt.public-key-location";
    ...
    public RSAPrivateKey readPrivateKey() throws IOException {
        String key = "creek.security.oauth2.jwt.private-key-location";
