...
public class DefaultOAuth2AccessToken implements Serializable, OAuth2AccessToken {
    ...
    /**
     * Additional information that token granters would like to add to the token, e.g. to support
     * new token types.
     *
    ...
    /**
     * Additional information that token granters would like to add to the token, e.g. to support
     * new token types. If the values in the map are primitive then remote communication is going to
     * always work. It should also be safe to use maps (nested if desired), or something that is
     * explicitly serializable by Jackson.
     *
