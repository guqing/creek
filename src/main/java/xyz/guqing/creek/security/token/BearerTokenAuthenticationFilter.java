...
import xyz.guqing.creek.security.JwtAuthenticationToken;
 ...
 * Token</a>.
 * <p>
 * This filter should be wired with an {@link AuthenticationManager} that can authenticate a {@link
...
public final class BearerTokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        JwtAuthenticationToken authenticationRequest = JwtAuthenticationToken.withToken(token);
    ...
    /**
     * Set the {@link AuthenticationEntryPoint} to use. Defaults to {@link
    ...
    /**
     * Set the {@link AuthenticationFailureHandler} to use. Default implementation invokes {@link
    ...
    /**
     * Set the {@link AuthenticationDetailsSource} to use. Defaults to {@link
