...
import xyz.guqing.app.exception.CreekInternalException;
...
public class ControllerEndpointAspect extends AbstractAspectSupport {
    ...
    @Pointcut("@annotation(xyz.guqing.app.model.annotation.ControllerEndpoint)")
